// import { baseRating, gradients, demoData } from '@/utils'; // Assuming demoData is imported from utils
// import { Fugaz_One } from 'next/font/google';

// // Mapping full month names to short form
// const months = {
...
//         <button className='mr-auto text-indigo-400 text-lg sm:text-xl duration-200 hover:opacity-60'>
//           <i className="fa-solid fa-circle-chevron-left"></i>
//         </button>
//         <p className={'text-center col-span-3 capitalize whitespace-nowrap textGradient ' + fugaz.className}>
//           {month} {year}
//         </p>
//         <button className='ml-auto text-indigo-400 text-lg sm:text-xl duration-200 hover:opacity-60'>
...
//                 // Calculate day index for the current cell
//                 let dayIndex = (rowIndex * 7) + dayOfWeekIndex - (firstDayOfMonth - 1);

//                 // Check if the day should be displayed
//                 let dayDisplay = dayIndex > daysInMonth || (rowIndex === 0 && dayOfWeekIndex < firstDayOfMonth) ? false : true;
...
//                 // Define the color based on demo data
//                 let color = demoData[dayIndex] 
