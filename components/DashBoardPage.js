...
export default function DashboardPage() {
  ...
  function countValues() {
    ...
    return { num_days: total_number_of_days, average_mood: total_number_of_days > 0 ? sum_moods / total_number_of_days : 0 }
  }
  ...
  return (
    <div className=' px-5 flex flex-col flex-1 gap-8 sm:gap-12 md:gap-16'>
